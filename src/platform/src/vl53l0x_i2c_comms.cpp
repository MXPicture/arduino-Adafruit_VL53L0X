...
int VL53L0X_i2c_init(SoftI2C* i2c) {
  i2c->begin();
  return VL53L0X_ERROR_NONE;
}
...
int VL53L0X_SoftWire_write_byte(uint8_t deviceAddress, uint8_t index, uint8_t data,
                       SoftI2C* i2c) {
  return VL53L0X_SoftWire_write_multi(deviceAddress, index, &data, 1, i2c);
}
...
int VL53L0X_SoftWire_write_word(uint8_t deviceAddress, uint8_t index, uint16_t data,
  ...
  buff[1] = data & 0xFF;
  buff[0] = data >> 8;
  return VL53L0X_SoftWire_write_multi(deviceAddress, index, buff, 2, i2c);
}
...
int VL53L0X_SoftWire_write_dword(uint8_t deviceAddress, uint8_t index, uint32_t data,
  ...
  return VL53L0X_SoftWire_write_multi(deviceAddress, index, buff, 4, i2c);
}
...
int VL53L0X_SoftWire_read_byte(uint8_t deviceAddress, uint8_t index, uint8_t *data,
                      SoftI2C* i2c) {
  return VL53L0X_SoftWire_read_multi(deviceAddress, index, data, 1, i2c);
}
...
int VL53L0X_SoftWire_read_word(uint8_t deviceAddress, uint8_t index, uint16_t *data,
                      SoftI2C* i2c) {
  uint8_t buff[2];
  int r = VL53L0X_SoftWire_read_multi(deviceAddress, index, buff, 2, i2c);
...
int VL53L0X_SoftWire_read_dword(uint8_t deviceAddress, uint8_t index, uint32_t *data,
                       SoftI2C* i2c) {
  uint8_t buff[4];
  int r = VL53L0X_SoftWire_read_multi(deviceAddress, index, buff, 4, i2c);
